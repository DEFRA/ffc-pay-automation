...
// This module connects to Pay Submission database and checks if the data exists for expected SBI.
...
module.exports = async () => {
  ...
  const client = new Client({
    ...
    port: process.env.PAYSUBMISSIONPORT,
    database: process.env.PAYSUBMISSIONDATABASE,
