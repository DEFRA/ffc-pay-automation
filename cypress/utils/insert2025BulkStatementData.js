...
VALUES
(13345678` + i + `,'` + i + ` The Lane','Area','District','City','County','AA2 1BB','documents.performance.test@gmail.com','133456789` + i + `','Test Farm',to_date('28-JUN-24 03:54:41','DD-MON-YY HH:MI:SS'))
ON CONFLICT ("sbi")
DO UPDATE SET
...
VALUES
(123456` + i + `,88765432` + i + `,13345678` + i + `,'133456789` + i + `',30000,50000,150000,99999999.99,50.00,55.00,65.00,70.00,15000.00,11000.00,65000.00,35000.00,126000.00,2000000.00,75000.00,37500.00,'2025-09-04 13:34:26.219')
...
VALUES
(88765432` + i + `,2025,'PY141024` + i + `',37500.00,to_date('01-AUG-24 12:00:00','DD-MON-YY HH:MI:SS'),2025);
`;


      await client.query(insertSql);
      console.log('✅ 2025 Data inserted successfully');
