...
# npm run cypress:dev:one -- "cypress\e2e\features\11_PPAE2EJourneyCredit.feature"
  ...
  Scenario Outline: 03 Send PPA message and verify queue increment (payment2)
    ...
    Examples:
      ...
      | ffc-pay-request-dev | Manual ledger assignment | ffc-pay-processing-dev |
  ...
  Scenario: 05 Approve payment in quality check queue
    ...
    Then I see a success message for "has been quality checked."
