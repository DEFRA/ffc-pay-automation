Feature: 28 SFI Expanded Pilot Payments

# npm run cypress:dev:one -- "cypress\e2e\features\28_SFIExpandedPayments.feature"
# npm run cypress:local:one -- "cypress\e2e\features\28_SFIExpandedPayments.feature"
...
# This feature file is designed to test the end-to-end journey of SFI Expanded payments in the local environment.
  ...
  #without the risk of data conflicts  
    ...
    When I send "sfi expanded payment" test data message to the service bus topic "ffc-pay-request-dev"
    ...
    Then I pull sfi expanded payments file from Azure Blob Storage and confirm that correct values have been generated

  #Updates template values with values used in payment message  

    When I send "sfi expanded return" test data message to the service bus topic "ffc-pay-return-dev"
    Then I confirm that "return" test data in dev has been inserted into ffc-pay-processing database

  #Updates template values with values used in payment message

    When I send "sfi expanded ppa" test data message to the service bus topic "ffc-pay-request-dev"
  ...
  #from payment file  
    ...
    And I select "Expanded SFI Offer" from the monitor schemes dropdown
    And I click on the "Continue" button
    Then I take a screenshot for Feature 28 and Scenario 2
...
#This scenario confirms that a return file message can be sent and processed correctly
  ...
  @local
  Scenario: 04 send SFI Expanded PPA file message and confirm processing
  ...
  #This scenario confirms that payment has been routed to Request Editor and can be enriched from the reporting data queue
    ...
    And I click on the "Irregular" debt type radio button
    And I enter a valid debt discovered date in the past
    Then I take a screenshot for Feature 28 and Scenario 5
    And I click on the "Continue" button
    And I click on the "Back" link
    And I click on the "Sign Out" link
  ...
  #This scenario confirms that payment can be approved from the ledger assignment queue in Request Editor
    ...
    And I click on the "Review" link
    And I click on the "Yes" provisional values radio button
    Then I take a screenshot for Feature 28 and Scenario 6
    And I click on the "Continue" button
    And I am on the "quality-check" subpage
    And I click on the "Sign Out" link
...
#This scenario confirms that payment can be approved from the quality check queue in Request Editor and that E2E journey is complete
    ...
    And I click on the "Review" link
    And I click on the "Yes" edited correctly radio button
    Then I take a screenshot for Feature 28 and Scenario 7
    And I click on the "Submit" button
  ...
  Scenario: 08 Confirm payment request processed in Payment Management
    ...
    Then I take a screenshot for Feature 28 and Scenario 8