...
# This feature file is designed to test the end-to-end journey of Lump Sums payment in the local environment.
  ...
  #without the risk of data conflicts  
    ...
    When I send "lump sums payment" test data message to the service bus topic "ffc-pay-request-dev"
    ...
    Then I pull lump sums payments file from Azure Blob Storage and confirm that correct values have been generated

  #Updates template values with values used in payment message  

    When I send "lump sums return" test data message to the service bus topic "ffc-pay-return-dev"
    Then I confirm that "return" test data in dev has been inserted into ffc-pay-processing database

  #Updates template values with values used in payment message

    When I send "lump sums ppa" test data message to the service bus topic "ffc-pay-request-dev"
