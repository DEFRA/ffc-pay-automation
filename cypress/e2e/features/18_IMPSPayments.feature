...
# npm run cypress:dev:one -- "cypress\e2e\features\18_IMPSPayments.feature"
# npm run cypress:local:one -- "cypress\e2e\features\18_IMPSPayments.feature"
...
# This feature file is designed to test the end-to-end journey of IMPS payment in the local environment.
  ...
  Scenario: 01 insert incorrect test data via service bus message to ffc-pay-request and confirm data is rejected
    ...
    When I send "imps error" test data message to the service bus topic "ffc-pay-request-dev"
...
#This scenario confirms that attempting to insert data that does not conform to the database limits is rejected correctly
  ...
  Scenario: 02 insert test data via service bus message to ffc-pay-request
    ...
    When I send the updated "imps-paymentFileMessage" message to the service bus topic "ffc-pay-request-auto"
...
#This scenario confirms that a return file message can be sent and processed correctly
    ...
    When I send the updated "imps-returnFileMessage" message to the service bus topic "ffc-pay-return-auto"
