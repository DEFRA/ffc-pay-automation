...
# This feature file is designed to test the end-to-end journey of COHTR and COHTC payment in the local environment.
  ...
  Scenario: 01 insert incorrect COHTR test data via service bus message to ffc-pay-request
    ...
    When I send "cshtr error" test data message to the service bus topic "ffc-pay-request-dev"
  ...
  #without the risk of data conflicts  
    ...
    When I send "cshtr payment" test data message to the service bus topic "ffc-pay-request-dev"
  ...
  #Updates template values with values used in payment message  
    ...
    When I send "cshtr return" test data message to the service bus topic "ffc-pay-return-dev"
    Then I confirm that "return" test data in dev has been inserted into ffc-pay-processing database

  #Updates template values with values used in payment message

    When I send "cshtr ppa" test data message to the service bus topic "ffc-pay-request-dev"
  ...
  #from payment file  
    ...
    Then I take a screenshot for Feature 22 and Scenario 2
 ...
 #First ensure that incorrect data will not be processed
  ...
  Scenario: 02 insert COHTR test data via service bus message to ffc-pay-request
    ...
    When I send the updated "cohtr-paymentFileMessage" message to the service bus topic "ffc-pay-request-auto"
...
#This scenario confirms that a return file message can be sent and processed correctly
    ...
    When I send the updated "cohtr-returnFileMessage" message to the service bus topic "ffc-pay-return-auto"
  ...
  Scenario: 04 send COHTR PPA file message and confirm processing
    ...
    When I send the updated "cohtr-ppaFileMessage" message to the service bus topic "ffc-pay-request-auto"
  ...
  Scenario: 08 Confirm payment request processed in Payment Management
    ...
    Then I take a screenshot for Feature 22 and Scenario 8
