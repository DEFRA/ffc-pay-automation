Feature: Service Bus Messaging
  ...
  Scenario: Sending a message to the service bus topic
    ...
    When I send a message to the service bus topic "ffc-pay-debt-data-test"
    Then the message should be received successfully for the service bus topic "ffc-pay-debt-data-test"
